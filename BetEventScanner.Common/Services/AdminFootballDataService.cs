...
namespace BetEventScanner.Common.Services
{
    public class AdminFootballDataService
    {
        ...
        //        CreateStatiscs(country, competitioContract.MatchId);

        //        UploadFixtures(country, competitioContract.MatchId);
        //    }
        //}

        //private void CreateStatiscs(CountryEntityTemp country, string id)
        //{
        //    var statistics = new CompetitionStatisticsEntity
        //    {
        //        MatchId = int.Parse(id)
        //    };
        ...
        //private void UploadFixtures(CountryEntityTemp country, string id)
        //{
        ...
        //private void StoreStatistics(MongoDbProvider mongo, IDictionary<CountryEntityTemp, CountryCompetitionsStatisticsEntity> statistics)
        //{
        ...
        //private void StoreCommon(MongoDbProvider mongo, List<CountryEntityTemp> countries)
        //{
        ...
        //private static void StoreTeams(MongoDbProvider mongo, IDictionary<CountryEntityTemp, CountryTeamsEntity> countryTeams)
        //{
        ...
        //private void StoreCompetitions(MongoDbProvider mongo, IDictionary<CountryEntityTemp, CountryCompetitionsEntity> competitions)
        //{
        ...
        //private void StoreFixtures(MongoDbProvider mongo, IDictionary<CountryEntityTemp, CountryCompetitionFixturesEntity> fixtures)
        //{
        ...
        //private static CountryEntityTemp GetCountryNameByDivision(CountryDivision countryDivision)
        //{
